...
\begin{proof}
We use the standard prime harmonic-sum and prime-counting estimates; see,
for example, \cite{Tenenbaum}. For $p\le X^{1-M}$, the inner sum is at most
...
Finally, consider differentiation at the minimizer. At a point
